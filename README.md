[![Header](https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:161b22,100:1f6feb&height=220&section=header&text=Murilo%20Costa&fontSize=42&fontColor=58a6ff&fontAlignY=35&desc=CS%20Student%20%7C%20Future%20Platform%20Engineer&descSize=18&descColor=8b949e&descAlignY=55&animation=fadeIn)](#)

[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&random=false&width=600&lines=Building+my+path+to+Platform+Engineering+🚀;CS+Student+@+CESAR+School;I+document+everything+I+learn;Projects+•+Failures+•+Progress)](https://git.io/typing-svg)

![Location](https://img.shields.io/badge/📍_Recife,_Brazil-0d1117?style=flat-square&labelColor=0d1117)
![CESAR School](https://img.shields.io/badge/🎓_CESAR_School-0d1117?style=flat-square&labelColor=0d1117)
![Goal](https://img.shields.io/badge/🎯_Platform_Engineer_Before_25-0d1117?style=flat-square&labelColor=0d1117)
...
### [Deploy Tracker](https://github.com/MuriloCosta29/deploy-tracker)

Multi-service monitoring system that registers applications and deploys,
runs periodic health checks, collects API metrics and exposes them through
Prometheus + Grafana dashboards.

**Stack:** FastAPI · PostgreSQL · Redis · Celery · Prometheus · Grafana · Nginx · Docker Compose · GitHub Actions (CI/CD)
